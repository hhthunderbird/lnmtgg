...
const Automate = () => {
  ...
  const handleCopyFromPreview = () => {
    ...
    if (isLimitReached) {
        alert("Você já atingiu seu limite de usos para esta hora.");
        return;
    }

    // Se não, rastreia o uso
    const canProceed = trackUsage();
    if (canProceed) {
        // Opcional: dar um feedback que a cópia contou como um uso
        console.log("Cópia detectada no preview. Um uso foi contado.");
    }
};
